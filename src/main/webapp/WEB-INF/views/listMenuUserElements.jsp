...
<h1 align="center">LISTA ELEMENTI MENU USER</h1>
<br>
<br>
<table style="border:1px solid #000000" class="center"> 
   <tr><td colspan="7"><a href="insertNewMenuUserElement" style=";font-size: 150%;">Add New Element</a></td></tr>  
</table>  
<br>
<br>
...
<table width="100%" style="border:1px solid #000000" class="table">
   ...
   <c:forEach var="menuElement" items="${menuUserElementsList}">  <!-- varStatus="status" -->
   ...
   <tr style="border:1px solid #000000">     
     ...
     <td style="border:1px solid #000000; background: #036;"><a	href="updateLinkUserInfo?link_id=${menuElement.link_id}&link_name=${menuElement.link_name}&link=${menuElement.link}&img_link=${menuElement.img_link}&target=${menuElement.target}&parent_id=${menuElement.parent_id}&subParent_id=${menuElement.subParent_id}">Modifica Info</a></td>
     <td style="border:1px solid #000000; background: #036;"><a href="deleteMenuUserElement?link_id=${menuElement.link_id}&parent_id=${menuElement.parent_id}&subParent_id=${menuElement.subParent_id}">Delete</a></td> 
